...
var battle_drop_event = function (e) {
    ...
    if ((e.path[0].getAttribute("data-player") != current_card.getAttribute(
        ...
        document.querySelector(`.lifePlayer[data-player='${e.path[0].getAttribute("data-player")}']`)
            .textContent -= (current_card.getAttribute("data-atk") - e.path[0].getAttribute("data-atk"));
